...
contract WalletFactory {
    ...
    function createAccount(
        ...
        if (codeSize > 0) {
            //If the code is non-empty, i.e. account already deployed, 
            //return the Wallet at the counterfactual address
    ...
    function getAddress(
        ...
        //Encode the intialize function in our wallet with the owners array as an argument into a bytes array
        bytes memory walletInit = abi.encodeCall(Wallet.initialize, owners);
        //Encode the proxyContract's constructor arguments which include the address walletImplementation and 
        //the walletInit
        ...
        //Use the hash and the salt to comute the counterfactual address of the proxy
